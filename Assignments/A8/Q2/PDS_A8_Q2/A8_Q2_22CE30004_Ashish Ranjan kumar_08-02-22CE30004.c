#include<stdio.h>
#include<stdlib.h>
int**allocate_array(int x, int y) { 
    int**b;
...
int**read_array(int x, int y) {
    ...
    for(int i=0; i<x; i++) {
        printf("Enter row %d:",i+1);#include<stdio.h>
#include<math.h>
...
void free_array(int**b,inty)
 ...
 int**multiply_matrices(int **b, int**a, int x, int y,int a, int p) {
     while(y==a) {
        int**q;
