...
printf("THE TOTAL INCOME IS: %d", sum);
    ...
    {
        tax=37500+ (0.15)*(sum-750000);
        printf(" your income tax: %f", tax);
    }
    else if (sum >= 1000001 && sum<= 1250000)
    {
        tax=75000+ (0.20)*(sum- 1000000);
        printf(" your income tax: %f", tax);
    }
    else if (sum >= 1250001 && sum<= 1500000)
    {
        tax=37500+ (0.15)*(sum-1250000);
        printf(" your income tax: %f", tax);
    }
    else if(sum>=1500001)
    {
